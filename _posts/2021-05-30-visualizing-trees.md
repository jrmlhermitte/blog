...
<h2 id="Bigquery:-The-pandas-API">Bigquery: The pandas API<a class="anchor-link" href="#Bigquery:-The-pandas-API"> </a></h2><p>These datasets are actually pretty small to download and work with offline.
